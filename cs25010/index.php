<?php
/*The code below redirects a user to an approiprate page if the user 
 * has already logged in without logging out. Else, the user's session would
 * officially be ended*/
...
<section id = "container">
	<section id = "mainArea">
		<p>Welcome to cs25010 mobile phone store. <br/>Input your name in the form below to log into the store.</p>	
		
		<!--
		A form that requests a user's name and sends to information to a 
		php file (store.php) that'll process it.
		-->
		<form action ="store.php" method = "post" autocomplete = "on">
		<table>
			<tr>
			<td><strong>Customer Name:</strong></td><td></td></tr>
			<tr><td><input type = "text" name = "name" autofocus placeholder="Name" required></td>
	...
	<!--
	Just below the navigation on the right side of the homescreen should be a display of
	...
	<footer>
		...
		<a href= "http://validator.w3.org/check?uri=http%3A%2F%2Fusers.aber.ac.uk%2Fola%2Fcs25010%2Findex.php">Validate Page</a>
		<br/>
